...
<div class="w3-services1  background">
        ...
        <div class="row w3-services-grids mt-lg-5 ">
            <div class="col-lg-7 w3-services-left-grid">
                <div class="header-section">
                    <h2 class="dubai_styling" style="font-size: 36px;">DUBAI</h2>
                    <h3 class="dubai_styling_para">GET IT BACK TOMORROW</h3>
                </div>
    ...
    <div class="w-full">
        <p class="text-center text-2xl change_text_para">First Ever Family Laundry in Dubai</p>
    </div>
</div>
<!-- //services block1 -->
...
<section class="position-relative overflow-hidden space-bottom mt-5">
    <div class="container">
        <div class="title-area text-center">
            ...
            <h2 class="sec-title">How Laundry Service Works in Dubai!</h2>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="process-card">
                        ...
                        <div class="box-content">
                            ...
                            <p class="box-text">Send us your location & address on WhatsApp: +971 52 273 2873 to schedule laundry service! Laundryservice.ae is available 7 days a week between 08:00 am and 11:00 pm.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="process-card active">
                        ...
                        <div class="box-content">
                            ...
                            <p class="box-text">Laundryservice.ae team will pick up your laundry bag right from your apartment, house, business or concierge.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="process-card">
                        ...
                        <div class="box-content">
                            ...
                            <p class="box-text">Your clean contactless-laundry will be dropped off at your location according to the time you specified</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="bg-top-center space" data-bg-src="{{asset('/assets/front/img/bg/service_bg_1.jpg')}}">
    <div class="container">
        <div class="title-area text-center">
            ...
            <h2 class="sec-title">Professional Laundry Services in Dubai!</h2>
