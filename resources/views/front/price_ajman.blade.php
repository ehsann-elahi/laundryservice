...
<div class="breadcumb-wrapper" data-bg-src="{{asset('/assets/front/img/bg/ajman.jpg')}}">
    <div class="container">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">PRICE LIST IN AJMAN & SHARJAH</h1>

            <ul class="breadcumb-menu">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li class="text-white">Price List in AJMAN & SHARJAH</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="col-md-4 col-12 px-0">
            <div class="form-group mb-3">
                <select class="form-control form-control-rounded mb-5" name="category_id" id="categorySelect" required>
                    ...
                    <option value="{{ $category->category }}" selected>PRICE LIST - {{ $category->category }}</option>
                    @endforeach
                </select>
            </div>
        </div>
...
<div class="widget widget_download px-5">
    ...
    <div class="download-widget-wrap px-5">
        <div class="row px-5">
            ...
            <div class="col-4 px-5">
                <a href="{{ asset('/assets/pdf/PriceListLinen&Bedding.jpg') }}" target="_blank"
                    class="th-btn rounded-10 "><i class="fa-light fa-file-image me-2"></i>Price List Linen
                    & Bedding</a>
            </div>
        </div>
...
<div class="overflow-hidden space" id="feature-area">
    <div class="container">
        <div class="title-area text-center">
            <h2 class="sec-title">PickUp & Delivery Services Pricing - AJMAN & SHARJAH</h2>
