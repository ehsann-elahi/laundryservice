...
@section('og:url', 'https://www.laundryservice.ae/view-cart')
@section('canonical', 'https://www.laundryservice.ae/view-cart')
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn theme-button px-3 fw-bold w-100" style="color:white; background-color:#2B2F7B" data-bs-toggle="modal" data-bs-target="#checkoutModal">
                            Proceed to Checkout
                        </button>

                        <div class="text-start mb-2 mt-2">
                            <a href="{{ route('shop') }}" style="color:white; background-color:#f7941f" class="btn theme-button px-3 fw-bold w-100">
