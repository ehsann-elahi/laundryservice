...
@section('og:url', 'https://www.laundryservice.ae/carpet-mattress-sofa-cleaning')
@section('canonical', 'https://www.laundryservice.ae/carpet-mattress-sofa-cleaning')
    ...
    <section class="space">
        <div class="container">
            ...
            <div class="row mb-5">
                ...
                <h3 style="font-size: 24px" class="mt-4">Why shall I choose professional carpet cleaner for my carpet?
                </h3>
