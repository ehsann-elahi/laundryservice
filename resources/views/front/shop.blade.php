...
@section('og:url', 'https://www.laundryservice.ae/buy-laundry-products')
@section('canonical', 'https://www.laundryservice.ae/buy-laundry-products')
							...
							<div class="col-xl-3 col-lg-4 col-sm-6 mb-4">
								<div class="th-product product-grid">
									...
									<div class="product-content">
										...
										<span class="count" style="color: #2B2F7B; font-weight: bold;">
											{{ $product->price }}
