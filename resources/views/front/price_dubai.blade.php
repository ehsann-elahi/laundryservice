...
@section('og:url', 'https://www.laundryservice.ae/laundry-price-list-dubai')
@section('canonical', 'https://www.laundryservice.ae/laundry-price-list-dubai')
...
<div class="breadcumb-wrapper" data-bg-src="{{asset('/assets/front/img/bg/breadcumb-bg.jpg')}}">
    <div class="container">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">PRICE LIST IN DUBAI</h1>

            <ul class="breadcumb-menu">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li class="text-white">Price List in Dubai</li>
            </ul>
        </div>
    </div>
</div>
...
<section class="space pt-0">
    <div class="container">
        <div class="title-area text-center">
            <h2 class="sec-title">Laundry & Dry Cleaning Pricing in Dubai</h2>
        </div>
...
<div class="overflow-hidden space" id="feature-area">
    <div class="container">
        <div class="title-area text-center">
            <h2 class="sec-title">PickUp & Delivery Services Pricing - Dubai</h2>
