...
@section('content')
    ...
    <div class="breadcumb-wrapper" data-bg-src="{{asset('/assets/front/img/bg/washnpress.jpg')}}">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Wash, Dry & Press Service</h1>
                <h3 class="text-white mt-3" style="font-size: 20px">Dubai & Abu-Dhabi</h3>
                <ul class="breadcumb-menu">
                    <li><a href="{{ route('index') }}">Home</a></li>
                    <li class="text-white">Wash & Press</li>
                </ul>
            </div>
        </div>
    </div>
    <section class="space-top space-extra-bottom">
        <div class="container">
             <h2 class="sec-title page-title mb-5 text-center" style="font-size: 32px">Wash & Press Service</h2>
            <div class="row">
                <div class="col-xxl-8 col-lg-8">
                    <div class="page-single mb-0">
                        <div class="page-img"><img loading="lazy"src="{{asset('/assets/front/img/service/2.jpg')}}" alt="Service Image" />
                        </div>
                        <div class="page-content">
                            ...
                            <p>Are you running short on time? A nursing mom? A student or running a hospitality company gets
                                ...
                                &
                                press service at an additional price.
                                <br>
                                Free collection & delivery service for orders over 65 <img class="aed">.
                            </p>
                            <div class="row mt-1">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="checklist">
                                        <ul>
                                            <li>Special detergent | 10 <img class="aed"></li>
                                            <li>Dry on Hanger | 0.25 <img class="aed">/item</li>
                                            <li>Additional Load | 27.5 <img class="aed">/Kg</li>
                            ...
                            <div class="row mt-50 gx-40" style="margin-top: 120px">
                                <div class="col-md-6 mb-30"><img loading="lazy"class="w-100"
                                        src="{{asset('/assets/front/img/service/wp2.png')}}" alt="service" /></div>
                                <div class="col-md-6 mb-30"><img loading="lazy"class="w-100"
                ...
                <div class="col-xxl-4 col-lg-4">
                    <aside class="sidebar-area">
                        ...
                        <div class="download-widget-wrap">
                            <a href="{{ asset('/assets/pdf/PriceListMen.jpg') }}" class="th-btn rounded-10"  target="_blank"><i
                        ...
                        <div class="media-body" style="height: 200px">
                            ...
                            <div class="checklist">
                                <ul>
                                    ...
                                    <li>Order less than 65 <img class="aed"> | + Extra Charges Apply</li>
                                    <li>Same-day delivery | (Normal Price * 2) <img class="aed"> + 165 <img class="aed"></li>
    ...
    <section class="space pt-0">
        <div class="container">
            <div class="title-area text-center">
                <h2 class="sec-title">Cheapest Wash & Press Service Abu Dhabi</h2>
            ...
            fetch(`/get-services?category=${category}`)
                ...
                .then(data => {
                    ...
                    data.forEach(service => {
                        const price = parseFloat(service.WP_Price);
                        if (price > 0) {
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="price-box">
                                        ...
                                        <div class="price-box_content">
                                            <h4 class="price-box_text">${service.WP_Price} <img class="aed2"></h4>
                                        </div>
                                    </div>
                                </div>`;
                        }
