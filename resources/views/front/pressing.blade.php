...
<img class="aed">, with no extra charges, with free next-day delivery service. Also available same-day ironing service & urgent 2-hour
pressing service at extra charge.')
@section('og:url', 'https://www.laundryservice.ae/ironing-abu-dhabi')
@section('canonical', 'https://www.laundryservice.ae/ironing-abu-dhabi')
...
<div class="breadcumb-wrapper" data-bg-src="{{asset('/assets/front/img/bg/breadcumb-bg.jpg')}}">
    <div class="container">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">Ironing Service</h1>
...
<section class="space-top space-extra-bottom">
    <div class="container">
        <h2 class="sec-title page-title text-center" style="font-size: 32px">Ironing & Pressing Service</h2>
        <p class="text-center mb-5">Our team of trained laundry professionals is dedicated to providing top-quality dry cleaning, wash & fold, and ironing services.</p>
        <div class="row">
            <div class="col-xxl-8 col-lg-8">
                <div class="page-single mb-0">
                    <div class="page-img"><img loading="lazy" src="{{asset('/assets/front/img/service/wp.png')}}" alt="Service Image" />
                    </div>
                    <div class="page-content">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 ">
                                ...
                                <div class="checklist">
                                    <ul>
                                        <li style="font-size: 20px;">6-Kg (package) | 119 <img class="aed"></li>
                            ...
                            <div class="col-6">
                                ...
                                <div class="checklist">
                                    <ul>
                                        <li style="font-size: 20px; ">Additional Ironing Load | 20 <img class="aed">/Kg</li>
                        ...
                        <div class="row mt-50 gx-40" style="margin-top: 120px">
                            <div class="col-md-6 mb-30"><img loading="lazy" class="w-100"
                                    src="{{asset('/assets/front/img/service/irioning.png')}}" alt="service" /></div>
                            <div class="col-md-6 mb-30"><img loading="lazy" class="w-100 h-100"
                                    src="{{asset('/assets/front/img/service/pressing.png')}}" alt="service" /></div>
                        </div>
                        <h3 style="font-size: 26px;">Services</h3>
                        <div class="checklist">
                            <ul>
                                <li>6-Kg (package) | 119 <img class="aed"></li>
                ...
                <aside class="sidebar-area">
                    ...
                    <div class="widget widget_call " style="margin-top: 100px"
                        ...
                        <div class="widget-call">
                            ...
                            <a href="%2b1636543569.html" class="call text-white">+971 52 273 2873</a> <a
                                href="mailto:info@laun.com" class="info-box_link">support@laundryservice.ae</a>
                        </div>
                    </div>
                </aside>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="feature-item wow fadeInUp">
                    ...
                    <div class="media-body" style="height: 200px">
                        ...
                        <div class="checklist">
                            <ul>
                                <li>Above than first 6-Kg we will not charge for next 6-Kg, instead it will count 20 <img class="aed">
                                    per Kg.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="media-body" style="height: 200px">
                        ...
                        <div class="checklist">
                            <ul>
                                ...
                                <li>Same-day delivery | (Normal Price * 2) <img class="aed"> + 119 <img class="aed"></li>
...
<section class="space pt-0">
    <div class="container">
        <div class="title-area text-center">
            <h2 class="sec-title">Cheapest Pressing Service Abu Dhabi</h2>
        ...
        <div class="row gy-4 justify-content-center">
            <div class="header-section text-center">
                <h4 style="font-size: 22px;">Steam Pressing (<img class="aed">)</h4>
            </div>
            ...
            fetch(`/get-services?category=${category}`)
                ...
                .then(data => {
                    ...
                    data.forEach(service => {
                        const price = parseFloat(service.P_Price);
                        if (price > 0) {
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="price-box">
                                        ...
                                        <div class="price-box_content">
                                            <h4 class="price-box_text">${service.P_Price} <img class="aed2"></h4>
                                        </div>
                                    </div>
                                </div>`;
                        }
