var Swiper = (function () {
    ...
    function O(e) {
        ...
        let x;
        i.isMoved && b !== s.touchesDirection && y && E && Math.abs(v) >= 1 && (s.loopFix({ direction: s.swipeDirection, setTranslate: !0 }), (x = !0)), s.emit("sliderMove", c), (i.isMoved = !0), (i.currentTranslate = v + i.startTranslate);
        let S = !0,
            T = r.resistanceRatio;
        if (
            (r.touchReleaseOnEdges && (T = 0),
            v > 0
                ? (y && E && !x && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
                  i.currentTranslate > s.minTranslate() && ((S = !1), r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** T)))
                : v < 0 &&
                  (y &&
                      E &&
                      !x &&
                  ...
                  i.currentTranslate < s.maxTranslate() && ((S = !1), r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** T))),
    ...
    function D(e) {
        ...
        if ((a >= 0 && s.evCache.splice(a, 1), ["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(e.type) && (!["pointercancel", "contextmenu"].includes(e.type) || (!t.browser.isSafari && !t.browser.isWebView))))
            return;
        ...
        return function (s) {
            ...
            "object" == typeof i && null !== i
                ? (!0 === e[a] && (e[a] = { enabled: !0 }),
                  ...
                  a in e && "enabled" in i ? ("object" != typeof e[a] || "enabled" in e[a] || (e[a].enabled = !0), e[a] || (e[a] = { enabled: !1 }), c(t, s)) : c(t, s))
                : c(t, s);
        };
    }
    const F = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    const s = this,
                        { params: a } = s;
                    a.cssMode || (a.autoHeight && s.updateAutoHeight(), I({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
                },
                transitionEnd: function (e, t) {
                    void 0 === e && (e = !0);
                    const s = this,
                        { params: a } = s;
                    (s.animating = !1), a.cssMode || (s.setTransition(0), I({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
                },
            },
            slide: {
    ...
    class j {
        constructor() {
            ...
            const o = {};
            l.modules.forEach((e) => {
                e({ params: t, swiper: l, extendParams: V(t, o), on: l.on.bind(l), once: l.once.bind(l), off: l.off.bind(l), emit: l.emit.bind(l) });
            });
            const d = c({}, q, o);
            return (
                (l.params = c({}, d, _, t)),
    ...
    const re = [
                ...
                if (t.params.loop) {
                    ...
                    const e = t.realIndex,
                        ...
                        r = (a) => {
                            ...
                            t.loopFix({ direction: a, activeSlideIndex: s, slideTo: !1 }), i === t.activeIndex && t.slideToLoop(e, 0, !1, !0);
                        };
        ...
        function (e) {
            ...
            function x(e) {
                ...
                if (((l = !1), (d = !1), u.push(e), !(u.length < 2))) {
                    if (((l = !0), (m.scaleStart = y()), !m.slideEl)) {
                        ...
                        if ((a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), (m.imageEl = a), (m.imageWrapEl = a ? b(m.imageEl, "." + s.containerClass)[0] : void 0), !m.imageWrapEl))
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                Object.assign(t.zoom, { enable: I, disable: k, in: P, out: L, toggle: z });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: a } = e;
            function i(e, t) {
        ...
        function (e) {
            ...
            function h(e) {
                ...
                const s = t.params.a11y,
                    a = e.target;
                (t.pagination && t.pagination.el && (a === t.pagination.el || t.pagination.el.contains(e.target)) && !e.target.matches(U(t.params.pagination.bulletClass))) ||
                    ...
                    setTranslate: () => {
                        ...
                        for (let o = 0; o < e.length; o += 1) {
                            ...
                            if (i.slideShadows) {
                                ...
                                e || (e = ie("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(p) - 0.5) / 0.5, 0), 1));
                            }
