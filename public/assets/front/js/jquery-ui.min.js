    ...
    (e.cleanData =
        ...
        (e.widget = function (t, i, s) {
            ...
            return (
                ...
                e.extend(a, n, { version: s.version, _proto: e.extend({}, s), _childConstructors: [] }),
                ...
                (a.prototype = e.widget.extend(o, { widgetEventPrefix: (n && o.widgetEventPrefix) || t }, h, { constructor: a, namespace: l, widgetName: t, widgetFullName: u })),
                n
        ...
        (e.Widget.prototype = {
            ...
            _toggleClass: function (e, t, i, s) {
                ...
                return (e = { extra: n ? t : i, keys: n ? e : t, element: n ? this.element : e, add: s }).element.toggleClass(this._classes(e), s), this;
            },
            _on: function (t, i, s) {
                var n,
                    a = this;
                        ...
                        (e =
                            (e =
                                "horizontal" === this.orientation
                                    ...
                                    : ((t = this.elementSize.height), e.y - this.elementOffset.top - (this._clickOffset ? this._clickOffset.top : 0))) / t) && (e = 1),
                    e < 0 && (e = 0),
                          ...
                          (i = ((l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                              ...
                              !0 === l.options.range &&
                                  ("horizontal" === l.orientation
                                      ? (0 === s && l.range.stop(1, 1)[u ? "animate" : "css"]({ left: i + "%" }, h.animate), 1 === s && l.range[u ? "animate" : "css"]({ width: i - t + "%" }, { queue: !1, duration: h.animate }))
                                      : (0 === s && l.range.stop(1, 1)[u ? "animate" : "css"]({ bottom: i + "%" }, h.animate), 1 === s && l.range[u ? "animate" : "css"]({ height: i - t + "%" }, { queue: !1, duration: h.animate }))),
                              (t = i);
                      })
                    : ((s = this.value()),
                      (n = this._valueMin()),
