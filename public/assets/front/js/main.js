!(function (e) {
    ...
    var s = new Swiper(".hero-slider-1", { loop: !0, parallax: !0, speed: 1500, autoplay: { delay: 6500, disableOnInteraction: !1 }, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" } });
    (s = new Swiper(".thumbsSlider", { loop: !0, spaceBetween: 10, slidesPerView: 3, freeMode: !0, watchSlidesProgress: !0 })),
        ...
        (s = new Swiper(".hero-slider-3", { loop: !0, parallax: !0, speed: 1500, autoplay: { delay: 6500, disableOnInteraction: !1 }, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" } }));
        ...
        (e.fn.sectionPosition = function (t, a) {
            e(this).each(function () {
                ...
                (n = Math.floor(l.height() / 2)),
                    ...
                    "top-half" === o ? (e(s).css("padding-bottom", r + n + "px"), l.css("margin-top", "-" + n + "px")) : "bottom-half" === o && (e(s).css("padding-top", i + n + "px"), l.css("margin-bottom", "-" + n + "px"));
            });
        });
        ...
        (e.fn.shapeMockup = function () {
            e(this).each(function () {
                var t = e(this),
                    ...
                    o = t.data("bottom"),
                    s = t.data("left");
                t.css({ top: a, right: n, bottom: o, left: s }).removeAttr("data-top").removeAttr("data-right").removeAttr("data-bottom").removeAttr("data-left").parent().addClass("shape-mockup-wrap");
            });
        }),
            ...
            e(this).each(function () {
                ...
                var o = setInterval(function () {
                    ...
                    i < 10 && (i = "0" + i),
                        ...
                        l < 10 && (l = "0" + l),
                        c < 10 && (c = "0" + c),
                        s < 0 ? (clearInterval(o), t.addClass("expired"), t.find(".message").css("display", "block")) : (n(".day").html(i), n(".hour").html(r), n(".minute").html(l), n(".seconds").html(c));
                }, 1e3);
            });
        }),
